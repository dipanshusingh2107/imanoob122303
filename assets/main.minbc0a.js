...
$(document).ready(function () {
  ...
  if ("function" == typeof userReady) (t = !0), userReady();
    ...
    for (
      ...
      r += `<div><input class="form-check-input" type="checkbox" id="${(o =
        "gen-" + a[i].replace(/\s/g, ""))}" value="${
        a[i]
    ...
    var l,
      c = gID("yearselect");
    for (i = envYear; i >= seasonalMinYear; i--)
      ((l = document.createElement("option")).value = i),
        (l.text = i),
        c.appendChild(l);
    "Winter" === envSeason
      ? (seasonId = 0)
  ...
  if (
    ...
    "gogo" === f
      ...
      ? searchMAL()
      : "all" === f
      ? ((useMAL = !0), (sEngineAdd = "&sengine=all"), dosearch(h))
      : searchMAL();
  } else
    null !== u && !1 === /[^a-zA-Z, -]/.test(u)
      ? (u.split(",").forEach((e) => {
          var t = "gen-" + e.replace(/\s/g, ""),
            o = gID(t);
          void 0 === notFoundID[t]
            ? (o.checked = !0)
            : "any" !== t &&
  ...
  t || renderUserCard(), checkloginhome(), t || weeklyrender(10);
  var v = !1;
  try {
  ...
  "ontouchstart" in window &&
    (document.addEventListener("touchstart", handleTouchStart, v),
    document.addEventListener("touchmove", handleTouchMove, v)),
  ...
  if (
      ...
      if (
        ...
        "Enter" === e.key && quicksearchloaded
          ...
          : e.target.value != querytemp &&
            ((quicksearchloaded = !1),
            (y = setTimeout(() => quicksearch(e.target.value), 400)),
            (b = -1)),
        quicksearchloaded)
      ) {
        var t = gClass("quickresult")[0].childNodes;
        "ArrowDown" === e.key && b < t.length - 1
          ? (-1 !== b && (t[b].className = null),
            (t[++b].className = "qresulthover"))
          : "ArrowUp" === e.key &&
            b > -1 &&
            ((t[b].className = null),
            -1 !== --b && (t[b].className = "qresulthover"));
      }
    }),
    ...
    (w.src = cdn + "/s/mascot.png"),
      w.setAttribute("id", "mascot"),
      document.body.appendChild(w);
  }
  if (isStorage("localStorage")) {
    var I = localStorage.getItem("lastopen"),
      k = localStorage.getItem("lasttitle");
    if (null !== I && null !== k && !lastwatchHidden && !t) {
      var D = "1";
      if ((k = k.replace(" - AniMixPlay", "")).includes(" Episode")) {
        var T = k.split(" Episode");
        (D = T[1]), (k = T[0]);
      }
      var x = Number(localStorage.getItem("lasttime"));
      if (
        (gID("lastwatchlink").setAttribute("href", I),
        (gID("lastwatchtitle").innerHTML =
          '<i class="glyphicon glyphicon-play"></i> ' +
          escapeHtml(k) +
          " Episode " +
          D),
        (gID("lastwatchurl").innerHTML = " watched " + daterelative2(x, !0)),
        ...
        $("#lastwatch").css("animation-name", "lastwatchspawn"),
          (lastwatchHidden = !0);
        var S = gID("lastwatchclosebtn");
        S.classList.remove("glyphicon-remove"),
          S.classList.add("glyphicon-chevron-right"),
          S.setAttribute("onClick", "lastwatchExpand()");
      }
    }
  }
  if (!isMobile()) {
    ...
    (L.id = "backtotopbtn"),
      ...
      (L.style.opacity = "0"),
      (L.innerHTML = '<i class="glyphicon glyphicon-menu-up"></i>'),
      document.body.appendChild(L);
    var M = !0;
    document.addEventListener("scroll", function () {
      window.scrollY > 50 && M
        ? ((M = !1), (L.style.opacity = "1"))
        : window.scrollY < 50 && !M && ((M = !0), (L.style.opacity = "0"));
    });
  }
  var E = performance.now();
  console.log(
    ...
    console.log(
      "%c Initial render time : " + (E - e) + "ms",
      "background: #222; color: #7eff4f"
    ),
    console.log(
      "Want to scrape? that's ok, just beaware there is ratelimit, high request rate will get you permanent capthca"
    );
});
var autoReload = !0,
  timeOnLoad = new Date();
...
const baseURL = "/",
  ...
  searchresulthtml = '<ul class="searchresult"></ul><div id="bottommsg"></div>';
...
function showmovie() {
  console.log("Load virtual page Movie"),
    ...
    window.history.replaceState("object or string", webtitle, "/?p=movie"),
    null == movie
...
function showdub() {
  console.log("Load virtual page Dub"),
    ...
    window.history.replaceState("object or string", webtitle, "/?p=dub"),
    null == dubhtml
      ? ($("#resultplace").html(searchresulthtml),
        $("#loadingtext").css("display", "block"),
        loaddub())
...
function showpopular() {
  console.log("Load virtual page Popular"),
    ...
    window.history.replaceState("object or string", webtitle, "/?p=popular"),
    null == popular
      ? ($("#resultplace").html(searchresulthtml),
        $("#loadingtext").css("display", "block"),
        loadpopular())
...
function showrecent() {
  console.log("Load virtual page Recent"),
    ...
    window.history.replaceState("object or string", webtitle, "/?p=recent"),
    null == recent
      ? ($("#resultplace").html(searchresulthtml),
        $("#loadingtext").css("display", "block"),
        loadrecent())
...
function showfollow() {
  console.log("Load virtual page Follow"),
    ...
    window.history.replaceState("object or string", webtitle, "/?p=updates"),
    null == followhtml
      ? ($("#resultplace").html(searchresulthtml),
        $("#loadingtext").css("display", "block"),
        loadfollow())
    ...
    success: function (t) {
      $(".searchresult").html(o + t.result),
        ...
        t.more
          ...
          : ((gID("bottommsg").innerHTML =
              "Removing anime here won't remove it from watchlist.<br>It's recommended to remove anime that you already finished, it still saved on your finished list."),
...
function dosearchfromindex() {
  return void shownotif("Search disabled");
  var e = $("#q").val();
  e.length > 300
...
function searchblur() {
  setTimeout(function () {
    "A" != document.activeElement.tagName &&
      ...
      ($("#coverlight").fadeOut(150), $(".quicksearchcontainer").fadeOut(150));
  }, 50);
}
...
function quicksearch(e) {
  if (
    ...
    return (
      $(".quickresult").html("Search disabled"), void (quicksearchloaded = !0)
    );
...
function searchE1() {
  (useE1 = useSpecific = !0),
    (useE2 = useE3 = useE4 = useE9 = useE6 = useE10 = useE11 = !1),
...
function searchE6() {
  (useE6 = useSpecific = !0),
    (useE1 = useE2 = useE3 = useE4 = useE9 = useE10 = useE11 = !1),
    (sEngineAdd = "&sengine=rush"),
    dosearchfromindex();
}
function searchE10() {
  (useE10 = useSpecific = !0),
    (useE1 = useE2 = useE3 = useE4 = useE9 = useE6 = useE11 = !1),
    (sEngineAdd = "&sengine=gdp"),
    dosearchfromindex();
}
function searchE11() {
  (useE11 = useSpecific = !0),
    (useE1 = useE2 = useE3 = useE4 = useE6 = useE10 = useE9 = !1),
    (sEngineAdd = "&sengine=al"),
    dosearchfromindex();
}
function searchMAL() {
  (useMAL = useSpecific = useAMX = !0),
    (useE1 = useE2 = useE3 = useE4 = useE9 = useE6 = useE10 = useE11 = !1),
...
var useE1 = (useE2 = useE3 = useE4 = useE9 = useE6 = useAMX = !0),
  useMAL = (useE11 = useSpecific = useE10 = !1),
  searchlimiter = !1;
function dosearch(e) {
  if (searchlimiter) shownotif("Search not yet ready");
    ...
    if (
      ...
      useAMX &&
        $.ajax({
          ...
          success: function (e) {
            if ("" !== e.result) {
              var t =
                '<div class="loadmoresearch2">GOGO (quick search)</div><ul class="items">' +
                e.result +
                "</ul>";
      ...
      useE1
        ? $.ajax({
            url: getapURL(1),
            type: "POST",
            data: { q2: e, origin: orig, d: "gogoanime.tel" },
            success: function (t) {
    ...
    if (
      (useE10 &&
        $.ajax({
          ...
          success: function (e) {
            var t =
              '<div class="loadmoresearch2" style="cursor: default;">GDP</div>' +
              e.result;
            (gID("result8").innerHTML = t), $(".name a").each(movedubtofront);
          },
          complete: function () {
            loadE8done = !0;
          },
        ...
        "no" === t && !0 !== useSpecific
          ...
          : setTimeout(function () {
              $.ajax({
                url: getapURL(6),
                type: "POST",
                data: { q: e, origin: orig },
                success: function (e) {
                  var t = '<div class="loadmoresearch2">RUSH</div>' + e.result;
                  (t = t.replace(
    ...
    useE11
      ? !0 !== useSpecific
        ...
        : $.ajax({
            url: "https://v11.jt822rupt6miiuc7pq8wwf237.workers.dev/",
            type: "POST",
            data: { q: e },
            success: function (e) {
      ...
      useMAL &&
        ...
        useSpecific && !1 === useE4 ? (limit = 18) : (limit = 6),
        $.ajax({
          url:
          ...
          type: "GET",
          success: function (e) {
            for (var t, o = [], n = e.data.length, a = 0; a < n; a++)
              null !== e.data[a].aired.from
                ? (t = new Date(e.data[a].aired.from).getFullYear()) > 2030 &&
                  (t -= 100)
                : (t = "Unknown"),
                (o[a] = {
                  title: escapeHtml(e.data[a].title),
                  url: escapeHtml("/anime/" + e.data[a].url.split("anime/")[1]),
                  picture: escapeHtml(e.data[a].images.jpg.image_url),
                  score: 100 * e.data[a].score,
                  infotext: t + " " + escapeHtml(e.data[a].type)
                });
            var s =
...
function genreclick() {
  ...
  $(".form-check-input:checked").each(function () {
    ...
    "" !== e || ("popular" !== sortFilter && "any" !== sortFilter)
      ? ("" !== e && (e = e.substring(1)), generalsearch(e))
      : backhome();
}
function generalsearch(e) {
  if (
    ...
    if (null !== r && "popular" !== r)
      for (var i = ["any", "popular", "rating", "latest"], l = 0; l < 4; l++)
        i[l] === r &&
          ((gID("topsortselect").selectedIndex = l), (sortFilter = r));
    if (null != r) {
      var c = r.charAt(0).toUpperCase() + r.slice(1);
      "Rating" === c && (c = "Best"), (o = c + " " + o), (t += "&orderby=" + r);
    } else
      "popular" === sortFilter &&
        (-1 !== ["Isekai", "Dub"].indexOf(e)
          ? ((gID("topsortselect").selectedIndex = 3),
            (sortFilter = "latest"),
            (o = "Latest " + o))
          : (o = "Popular " + o),
        (t += "&orderby=" + sortFilter));
  ...
  if (o.includes(t)) {
    ...
    if (
      ...
      null !== gID("readmorebtn") &&
        ...
        (gID("navtab").style.display = "none"),
        (gID("openschedulebtn").style.display = "none")),
        window.history.pushState("object or string", i + " - AniMixPlay", r),
        "undefined" != typeof ga &&
        ...
        (gID("resultplace").innerHTML =
          ...
          searchresulthtml),
        (gID("loadingtext").style.display = "block"),
        console.log("Request virtual page " + i),
        loadseasonal(0),
        isMobile() &&
          ($(".rightside").css("animation-name", "moveout2mobile"),
          (mobilemenuopen = !1));
    ...
    success: function (s) {
      if (void 0 !== s.anime) {
        ...
        for (
          ...
          d < c &&
          (!0 === l[d].r18 ||
            (1 === filter && l[d].continuing) ||
            (2 === filter && !l[d].continuing) ||
            ((r = l[d].image_url.includes("images/anime")
              ? cdn + "/min/mal" + l[d].image_url.split("images/anime")[1]
              : l[d].image_url),
            (i[d] = {
              title: escapeHtml(l[d].title),
              url: escapeHtml("/anime/" + l[d].url.split("anime/")[1]),
              picture: escapeHtml(r),
              score: 100 * l[d].score
            }),
            null === l[d].type && (l[d].type = ""),
            l[d].continuing
              ? 2 === filter
                ? (null !== l[d].airing_start &&
                    l[d].airing_start.includes("-") &&
                    ((date = l[d].airing_start.split("-")),
                    (tmp = Number(date[1])),
                    tmp > 9
                      ? (o = "Fall " + date[0])
                      : tmp > 6
                  ...
                  (i[d].infotext = escapeHtml(`${o} ${l[d].type}`)))
                : (i[d].infotext = escapeHtml(l[d].type))
              : (i[d].infotext = `${curSeason} ${curYear} ${l[d].type}`),
            (t = d + 1),
            !(--a < 1)));
          d++
        );
        (gID("bottommsg").innerHTML =
          a < 1
            ...
            : ""),
          (gClass("searchresult")[0].innerHTML = n + buildlist(i));
...
function onLoggedin(e) {
  ...
  (i.style.display = "block"),
    ...
    window.location.pathname.includes("/user")
      ...
      : isMobile() || (i.parentNode.style.borderBottom = "1px solid #3c3c3c");
}
...
function connectGoogle() {
  ...
  if (
    ...
    (authwindow = window.open(o, "authwindow", "width=500,height=600")) ||
      (authwindow = window.open(o, "authwindow")),
    ...
    $.ajax({
      ...
      success: function (e) {
        ...
        (gID("scheduletimezone").innerHTML = c >= 0 ? "UTC+" + c : "UTC" + c),
          (o[i] += ' <span style="color:#ffed8b">(Today)</span>');
        var d,
          u =
            '<div style="color:#aa9f68;text-align:right;margin-left:10px;margin-top:1px;">- Now -</div>';
        isStorage("localStorage") &&
          "string" !=
            typeof (markedSchedule = localStorage.getItem("markedSchedule")) &&
          (markedSchedule = "");
        for (var m = 0; m < 7; m++) {
          t += `<div class="scheduletitle">${o[i]}</div>`;
          for (var g = 0; g < n; g++)
            e[g].daynum === i &&
              (a &&
                e[g].timeday > l &&
              ...
              markedSchedule.includes(d + ",") &&
                (t +=
                  ' style="background-color:#1d2f1d;padding:0 5px;border-left:2px solid lime;" onClick="markSchedule(' +
                  d +
                  ')"'),
              (t += ` id="schedule${d}" class="schedulelist"><a href="/anime/${d}">${e[g].name}</a></div><div class="airtime" onClick="markSchedule(${d})">${e[g].timeday}</div>`));
          a && (t += u), (a = !1), 7 === ++i && (i = 0);
        }
  ...
  if (scheduleopen !== !t) {
    isMobile()
      ? t
        ...
        : $("#playerleftsidebar").css("animation-name", "movein2mobilerecomend")
      : t
...
function weeklyrender(e = 10) {
  ...
  if (10 === e)
    if ("" === weekly10) {
      ((n = document.createElement("script")).src = "/assets/weeklytop.min.js"),
...
function readmore() {
  ...
  return (
    ...
    document.querySelector("#readmorebtn i").classList.add("glyphicon-menu-up"),
    !1
  );
}
function readless() {
...
function reducegenre() {
  return (
    (genreExpanded = !1),
    (gID("genreplace").style.height = "205px"),
    gID("expandbtn").setAttribute("onClick", "expandgenre()"),
    document
      .querySelector("#expandbtn i")
      .classList.remove("glyphicon-menu-up"),
    document.querySelector("#expandbtn i").classList.add("glyphicon-menu-down"),
    !1
  );
}
function infoclose() {
  ...
  return (
    Object.keys(e).forEach(function (o) {
      if (
        ...
        "string" == typeof e[o].timetop &&
          ("" === e[o].timetop || -1 !== e[o].timetop.indexOf("<")
            ? (t += `<div class="timetext">${e[o].timetop}</div>`)
            : (t += `<div class="timetext">${daterelative2(
                e[o].timetop
              )}</div>`)),
        void 0 !== e[o].score)
      ) {
...
function movedubtofront2(e) {
  return (
    "(dub)" === (e = e.trim()).substring(e.length - 5).toLowerCase() &&
      (e = "<span class='dubtag'>[Dub]</span> " + e.substring(0, e.length - 5)),
    e
  );
}
  ...
  if (!isNaN(n) && null !== e) {
    ...
    o =
      s < 2
        ...
        ? "yesterday"
        : s < l
        ? Math.floor(s / i) + " days ago"
        : s < 5184e3
        ? "1 month ago"
        : s < c
        ? Math.floor(s / l) + " months ago"
...
function getrequest(e) {
  ...
  return (
    t || (t = location.search.split("?" + e + "=")[1]),
    void 0 !== t ? decodeURIComponent(t.split("&")[0]) : null
  );
}
